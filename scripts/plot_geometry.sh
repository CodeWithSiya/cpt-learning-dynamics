...
#SBATCH --job-name="cpt-plot-geometry"
#SBATCH --mail-user=mdnsiy014@myuct.ac.za
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --output=logs/plot_geometry_%j.log
#SBATCH --error=logs/plot_geometry_%j.log
...
echo "=== Plotting geometry result grids ==="

uv run python src/visualisation/plot_geometry.py \
    --results-dir ${SCRATCH}/cpt-learning-dynamics/results \
    --output-dir ${SCRATCH}/cpt-learning-dynamics/results/plots/geometry \
    "$@"
